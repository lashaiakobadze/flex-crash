...
const NetworkStatus: React.FC<NetworkStatusProps> = ({ 
  ...
  const getBarHeights = () => {
    ...
    switch (quality) {
      case 'excellent': return { low: 8, middle: 10, high: 12 };
      case 'good': return { low: 6, middle: 8, high: 10 };
      case 'fair': return { low: 4, middle: 6, high: 0 };
      case 'poor': return { low: 2, middle: 0, high: 0 };
      default: return { low: 0, middle: 0, high: 0 };
    }
  };
